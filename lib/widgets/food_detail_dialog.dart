    ...
    return AlertDialog(
      ...
      title: Row(children: [
        ExcludeSemantics(child: Container(padding: const EdgeInsets.all(10),
          decoration: BoxDecoration(color: Colors.teal.withValues(alpha: isDark ? 0.15 : 0.1), shape: BoxShape.circle),
      ...
      content: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _nutritionRow(Icons.grain, Colors.teal, '${food.carbsPer100g}g carbs / 100g', isDark),
